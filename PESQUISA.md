...
> **Entity Framework Core e ORM**
  ...
  Ao executar o comando dotnet ef database update no terminal, o Entity Framework irá verificar as alterações que não foram aplicadas e atualizar automaticamente a estrutura do banco de dados.
